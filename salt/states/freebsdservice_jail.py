def enable(name, jail=None):
    ...
    enhanced_state = ""
    current_state = __salt__["service.enabled"](name, jail=jail)
...
def disable(name, jail=None):
    ...
    enhanced_state = ""
    current_state = __salt__["service.disabled"](name, jail=jail)
    if current_state is False:
...
def running(name, jail=None, enable=None):
    ...
    if enable is True:
        current_state = __salt__["service.status"](name, jail=jail)
        if current_state is False:
            new_state = __salt__["service.enable"](name, jail=jail)
            ret["enable"] = True
            ret["changes"] = {
    ...
    if enable is False:
        ...
        if current_state is True:
            ...
            ret["enable"] = True
            ret["changes"] = {
                "old": "Jail {0} service {1} enabled".format(jail, name),
                "new": "Jail {0} service {1} disabled".format(jail, name),
            }
        if current_state is True:
            ret["enable"] = True
